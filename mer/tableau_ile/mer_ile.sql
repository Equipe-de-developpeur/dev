...
--
-- Déchargement des données de la table `commentaire_île_du_petit_gaou`
--

INSERT INTO `commentaire_île_du_petit_gaou` (`comment_id`, `parent_comment_id`, `comment`, `comment_nom_membre`, `date`) VALUES
(1, 0, 'test gaou\r\n', 'David', '2020-09-04 10:14:05'),
(2, 1, 'reponse', 'David', '2020-09-04 10:14:16'),
(3, 0, 'blabla', 'David', '2020-09-04 10:14:29');
...
--
-- Déchargement des données de la table `commentaire_îlot_de_la_gabinière`
--

INSERT INTO `commentaire_îlot_de_la_gabinière` (`comment_id`, `parent_comment_id`, `comment`, `comment_nom_membre`, `date`) VALUES
(3, 0, 'test Gabinière', 'David', '2020-09-03 16:46:24');
...
(20, 'Le Lion de terre', 'Saint Raphael', NULL, 0, 0, 43.4081, 6.77364, 38.07, ''),
(21, 'Île d\'Or', 'Saint Raphael', NULL, 0, 0, 43.4107, 6.84668, 42.94, ''),
(22, 'Île des Vieilles', 'Saint Raphael', NULL, 0, 0, 43.4272, 6.89415, 45.5, '');
