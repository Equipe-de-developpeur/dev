...
if(isset($_POST['critere'])) { //Si a un critère a été envoyé
    if ($_POST['critere'] == "nom") { //Si ce critère est nom
            $sql = $pdo->prepare("SELECT * FROM `jm_mer_liste_port` ORDER BY `jm_mer_liste_port`.`lieu` ASC");
            ...
            $sql = $pdo->prepare("SELECT * FROM `jm_mer_liste_port` ORDER BY `jm_mer_liste_port`.`localisation` ASC");
            ...
            $sql = $pdo->prepare("SELECT * FROM `jm_mer_liste_port` ORDER BY `jm_mer_liste_port`.`label_pp` DESC");
            ...
            $sql = $pdo->prepare("SELECT * FROM `jm_mer_liste_port` ORDER BY `jm_mer_liste_port`.`label_aeb` DESC");
            ...
            $sql = $pdo->prepare("SELECT * FROM `jm_mer_liste_port` ORDER BY `jm_mer_liste_port`.`label_pb` DESC");
