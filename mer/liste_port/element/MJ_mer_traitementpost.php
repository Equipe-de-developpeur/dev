...
if(isset($_POST['critere'])) { //Si a un critère a été envoyé
    if ($_POST['critere'] == "nom") { //Si ce critère est nom
            ...
            $msg = 'Votre liste est rangée selon l\'ordre alphabétique des noms.';
        }
            ...
            $msg = 'Votre liste est rangée selon l\'ordre alphabétique des emplacements.';
        }
            ...
            $msg = 'Votre liste est rangée selon leur label "Port Propre".';
        }
            ...
            $msg = 'Votre liste est rangée selon leur label "Actifs en Biodiversité".';
        }
            ...
            $msg = 'Votre liste est rangée selon leur label "Pavillon Bleu".';
        }
            ...
            $msg = 'Votre liste est rangée selon leur note moyenne par les utilisateurs';
    }
}
