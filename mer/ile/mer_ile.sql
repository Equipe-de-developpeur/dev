...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 09 sep. 2020 à 16:57
...
CREATE TABLE `commentaire_île_de_port_cros` (
  `comment_id` int(11) NOT NULL,
  `parent_comment_id` int(11) NOT NULL,
  `comment` varchar(255) NOT NULL,
  `comment_nom_membre` varchar(100) NOT NULL,
...
INSERT INTO `utilisateur` (`utilisateur_id`, `utilisateur_pseudo`, `utilisateur_password`, `utilisateur_email`, `utilisateur_image`, `utilisateur_role`, `utilisateur_nb_comm`) VALUES
(9, 'Sangohan83', '0288f4ec2ac957a5f5deabe504896af3292e5616', 'david.walter.72000@gmail.com', '9.jpg', 'Admin', 2);
...
--
ALTER TABLE `commentaire_île_de_port_cros`
  ADD PRIMARY KEY (`comment_id`);
