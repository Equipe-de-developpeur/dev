...
.hero:before
{
	background: url("img/<?php echo str_replace(' ','_',$resultat_ile->liste_ile_nom);?>.jpg");
}
...
<a href="#"><img src="img/<?php echo str_replace(' ','_',$resultat_ile->liste_ile_nom);?>_mini.jpg" alt="cover" class="cover"></a>
<div class="hero">
<div class="details">
